/*
  # Complete system setup for Skoropad platform

  1. New Tables
    - `users` - User accounts with roles (user, vip, moderator, admin)
    - `advertisements` - User advertisements with categories and VIP status
    - `admin_logs` - Admin action logging system

  2. Security
    - Enable RLS on all tables
    - Add policies for user management, advertisement creation, and admin actions
