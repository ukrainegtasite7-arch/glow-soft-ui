-- Create RPC to insert advertisements within a secure transaction bypassing RLS while enforcing checks
...
BEGIN
  ...
  INSERT INTO public.advertisements (
    user_id, category, subcategory, title, description, images, discord_contact, telegram_contact, is_vip
  ) VALUES (
    p_user_id, p_category, p_subcategory, p_title, p_description, coalesce(p_images, '{}'), p_discord, p_telegram, v_is_vip
  )
  RETURNING * INTO v_ad;
